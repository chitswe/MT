...
module.exports=(sequelize,DataTypes)=>{
    var UserAccount = sequelize.define('UserAccount',{
        ...
        AccountKitId:DataTypes.BIGINT
    },{
        classMethods:{
            associate:(models)=>{
                models.UserAccount.hasOne(models.User);//add UserAccountId column to User Table.
                models.User.belongsTo(UserAccount);

                models.UserAccount.hasOne(models.Dealer);//add UserAccountId column to Dealer Table.
                models.Dealer.belongsTo(models.UserAccount);

                models.UserAccount.hasOne(models.Customer);
